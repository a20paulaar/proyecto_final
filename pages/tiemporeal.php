...
<body>
    ...
    <div id="container">
        <section>
            <select class="form-select form-select-sm" id="paradas" name="paradas">
                <option value="0" selected="true" disabled="disabled">SELECCIONE PARADA</option>
            </select>
            <div id="proximos">
                <h2 id="proximos_t"></h2>
                <span class="hacia">Hacia Oporto-Casa da Musica:</span> <span id="asc"></span>
                <br/>
                <span class="hacia">Hacia Vigo-Estacion Autobuses:</span> <span id="desc"></span>
            </div>
        </section>
        <aside>
            <h2>Noticias</h2>
    ...
    <script>cargarParadasEnLista();</script>
</body>
</html>